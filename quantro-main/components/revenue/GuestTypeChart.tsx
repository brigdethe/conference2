    ...
    switch (view) {
      case 'guest-type':
        return {
          ...
          data: [
            { label: 'Paid', value: dashboard.paidGuests, color: 'bg-slate-900' },
            { label: 'Invited', value: dashboard.invitedGuests, color: 'bg-slate-300' },
          ],
          type: 'bar',
          total: dashboard.paidGuests + dashboard.invitedGuests,
        };
      case 'invited-status':
        return {
