                        ...
                        <div className={`see-you-tab__left ${showPrintTicketButton ? 'see-you-tab__left--visible' : ''}`}>
                            {showPrintTicketButton && (
                                <>
                                    ...
                                    <a
                                        href="/#relevant-documents"
                                        target="_blank"
                                        rel="noopener noreferrer"
                                        className="countdown-ask-card countdown-ask-card--docs"
                                    >
                                        <div>
                                            <p className="countdown-ask-card__label">Prepare for the seminar</p>
                                            <p className="countdown-ask-card__heading">Relevant documents</p>
                                        </div>
                                        <svg width="18" height="18" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round">
